...
(function() {
  ...
  var Events = Backbone.Events = {
    ...
    on: function(name, callback, context) {
      // TWO // if (!eventsApi(this, 'on', name, [callback, context]) || !callback) return this;
    ...
    once: function(name, callback, context) {
      // TWO // if (!eventsApi(this, 'once', name, [callback, context]) || !callback) return this;
      var self = this;
    ...
    off: function(name, callback, context) {
      ...
      if (!this._events/** TWO //|| !eventsApi(this, 'off', name, [callback, context])**/) return this;
    ...
    trigger: function(name) {
      ...
      // TWO // if (!eventsApi(this, 'trigger', name, args)) return this;
